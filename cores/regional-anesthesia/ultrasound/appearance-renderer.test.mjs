...
assert.equal(a.version,'A6.5');
assert.equal(a.profileId,ULTRASOUND_APPEARANCE_PROFILE.A6_ADDUCTOR_CANAL_V5);
...
console.log('A6.5 WORKER-CONTROLLED IMAGING RENDERER PASS');
